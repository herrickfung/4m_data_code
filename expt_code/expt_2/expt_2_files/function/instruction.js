...
var parti_info_questions = [
  [
    {
      type: 'text',
      prompt: "Prolific ID number / GTID number: ",
      required: true,
    },
    {
      type: 'text',
...
var welcome_text =[
  ...
  '<p style="font-size:20px;color:#000000;text-align:left">'+
  'This is a 2-day experiment. <br><br> Today, you will complete 3 practice blocks, 2 calibration blocks, <br> and 5 runs of 5 experimental blocks, with each block containing 32 trials.' +
  '<br><br> You will have the opportunity to take break after each block.' +
  '<br><br> Most people can complete these procedures in 60 minutes.' +
...
var welcome_text_d2 =[
  '<p style="font-size:20px;color:#000000;text-align:left">'+
  'Welcome back to the experiment! Thanks again for your participation.' +
  '<br><br> You may navigate back and forth with the buttons below or <br> with the Left and Right Arrow on your keyboard.' +
  '</p>',
  ...
  '<p style="font-size:20px;color:#000000;text-align:left">'+
  'Today, you will complete 2 recall blocks and 5 runs of 5 experimental blocks, with each block containing 32 trials.' +
  '<br><br> You will have the opportunity to take break after each block.' +
  '<br><br> Most people can complete these procedure in less than 60 minutes.' +
  '<br><br> Please do your best to take the experiment in a single sitting <br> without excessive interruptions or taking very long breaks.'+
  '<br><br> Now, we will switch to the fullscreen mode, please DO NOT escape the fullscreen mode <br> until the experiment will have been completed.'+
  '</p>',
];
...
// On each trial, you will see quickly-presented orientation patches close to 45 degrees.
  ...
  '<img src = "expt_2_files/img/gabor_45.png" width = 200px text-align = center>' +
  '<p style="font-size:20px;color:#000000;text-align:left">' +
  ...
  '<th>' +
  '<figure>' +
  '<img src = "expt_2_files/img/gabor_left.png" width = 200px text-align = center>' +
  ...
  '<th>' +
  '<figure>' +
  '<img src = "expt_2_files/img/gabor_right.png" width = 200px text-align = center>' +
  ...
  '<img src = "expt_2_files/img/resp_screen.png" width = 300px text-align = center>' +
  '<p style="font-size:20px;color:#000000;text-align:left">' +
  ...
  '<br><br> Otherwise, press next and get ready for the practice/recall block!' +
  '</p>',
  ];
...
var start_prac_instruct_4 =
  '<p style="font-size:20px;color:#000000;text-align:left">' +
  'Great!' +
  '<br><br> Hopefully, the previous block recalls your memory about the task. You should find the previous block ' +
  'very easy. <br> You already knew, the tilts in the actual experiment are much closer to 45 degrees.' +
  '<br><br> In the following block, the tilts will be closer to the experimental setting and no feedback will be given.'+
  '<br><br> We will move on to the experimental blocks afterwards.'+
  '<br><br> Press spacebar now to start the final recall block.' +
  '</p>';
...
var start_experiment_instruct =
  ...
  '<br><br> You will then complete 5 runs of 5 experimental blocks,' +
  '<br> with each experimental block containing 32 trials.' +
  ...
  "<br> number of strips during the experiment, these are all part of the experiment."+
...
var start_experiment_instruct_d2 =
  '<p style="font-size:20px;color:#000000;text-align:left">' +
  'Cool! You\'ve completed all the recall blocks, take a short break.' +
  '<br><br> You will now complete 5 runs of 5 experimental blocks,' +
  '<br> with each experimental block containing 32 trials.' +
  '<br><br> You may take breaks after each run and block.' +
  "<br><br> Don't be surprised if you see stimulus with different size, blurriness, and " +
  "<br> number of strips during the experiment, these are all part of the experiment."+
...
var debrief_text =
  '<p style="font-size:20px;color:#000000;text-align:left">' +
  "Excellent! You\'ve completed today's procedure." +
  "<p.>" +
  ...
  "<br><br> Thank you for your participation, have a good day, and see you on the other day!" +
  '</p>';
