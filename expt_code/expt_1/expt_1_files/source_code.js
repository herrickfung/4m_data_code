...
var trials_to_break = 24;  //define how many trials to have break in expeirmental trials
...
var subject_id = Math.floor(Math.random()*100000000);

const jsPsych = initJsPsych({
  override_safe_mode: true,
  on_finish: function(){
    jsPsych.data.get().localSave('csv', "SVE1_" + subject_id + ".csv")
    window.location = "https://app.prolific.com/submissions/complete?cc=C19FDL7V";
  },
});
...
const preload = {
  type: jsPsychPreload,
  images: ['expt_1_files/img/card.png',
           'expt_1_files/img/gabor_45.png',
           'expt_1_files/img/gabor_left.png',
           'expt_1_files/img/gabor_right.png',
           'expt_1_files/img/resp_screen.png',
           ]
};
...
const chinrest = {
  ...
  resize_units: "deg",
  pixels_per_unit: 30,
  item_path: "expt_1_files/img/card.png",
...
var debriefing = {
  ...
  on_start: function(){
    saveData("data/SVE1_" + subject_id + ".csv", jsPsych.data.get().csv());
  },
};
